...
const menuData = [
  ...
  { id: 'app3', name: 'Mandu Gangjung', price: 9.00, category: 'Appetizers/Sides', image: "https://i.ibb.co/gLLJmwPh/Mandu.png" },
  ...
  { id: 'des6', name: 'Vegan Banana Manifesto Cake', price: 3.99, category: 'Desserts', image: "https://i.ibb.co/4gDdrbhS/Lemon.jpg"},
  ...
  { id: 'des13', name: 'Chocolate Torte Flourless Cake Slice', price: 3.99, category: 'Desserts', image: "https://i.ibb.co/yBprtZKG/Sweet-Street-Desserts-Fabulous-Chocolate-Chunk-Brownie.jpg"},
  { id: 'des14', name: 'Chocolate Peruvian Brownie', price: 2.99, category: 'Desserts', image: "https://i.ibb.co/FL2bZ6dQ/Peruvian.jpg" },
  { id: 'des15', name: 'Chewy Marshmallow with Brown Butter Bar', price: 3.10, category: 'Desserts', image: "https://i.ibb.co/ccnhZfvX/Sweet-Street-Desserts-Chewy-Marshmallow.jpg" },
